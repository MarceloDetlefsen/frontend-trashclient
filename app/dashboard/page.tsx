...
import DashboardMap from '@/app/components/DashboardMap';
  ...
  const avgAnalysis =
    records.length > 0
      ? {
          ...
          eWastePercentage:
            records.reduce((s, r) => s + (r.eWastePercentage ?? 0), 0) / records.length,
          hazardousPercentage:
            records.reduce((s, r) => s + (r.hazardousPercentage ?? 0), 0) / records.length,
          specialTreatmentPercentage:
            records.reduce((s, r) => s + (r.specialTreatmentPercentage ?? 0), 0) / records.length,
        }
      : null;
  ...
  return (
    <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="bg-white rounded-xl border border-slate-200 p-4 mb-8">
        ...
        <div className="h-[480px] rounded-xl overflow-hidden bg-slate-50">
          <DashboardMap records={records} />
        </div>
      </div>
